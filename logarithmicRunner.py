...
def logarithmicRunner(offset, logOffset, alpha, n, tFactor, measureStep, runCount, threadCount): 
    # CONSTANTS
    OFFSET = offset
    ...
    schedules = [mcaa.continuousLogarithmicSchedule(T, OFFSET, LOG_OFFSET) for i in range(RUN_COUNT)]
