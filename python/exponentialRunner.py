...
def exponentialRunner(offset, base, alpha, n, tFactor, measureStep, runCount, threadCount): 
    # CONSTANTS
    OFFSET = offset
    BASE = base
    ALPHA = alpha
    ...
    schedules = [mcaa.continuousExponentialSchedule(T, OFFSET, BASE) for i in range(RUN_COUNT)]
